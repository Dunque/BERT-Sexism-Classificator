...
modelPath = absolutePath + "models/multiBothBertSynonyms/"
...
def load_data(translated_data=translated_data_path,
    ...
    # English version
    eng_data = data[['id', 'English', 'LabelTask2']]
    eng_data = eng_data.rename(columns={'id': 'id', 'English': 'tweet', 'LabelTask2': 'label'})

    # Spanish version
    esp_data = data[['id', 'Spanish', 'LabelTask2']]
    esp_data = esp_data.rename(columns={'id': 'id', 'Spanish': 'tweet', 'LabelTask2': 'label'})
