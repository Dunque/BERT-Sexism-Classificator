...
validPath = "../../data/fasttext/"

# Load data and set labels
data = pd.read_csv(translated_data)

#English version
data = data[['id', 'English', 'task1']]
data = data.rename(columns= {'id':'id', 'English':'tweet', 'task1':'label'})
...
text = [remove_clutterEN(text) for text in data.tweet.values]
