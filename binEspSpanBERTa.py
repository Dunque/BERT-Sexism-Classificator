...
# Importing a dataset of Spanish movie subtitles from OpenSubtitles.
# This dataset has a size of 5.4 GB, and we will train on a subset of ~300 MB

# Download and unzip movie substitle dataset

# if not os.path.exists('spanberta/data/dataset.txt'):
#   os.system("wget 'https://object.pouta.csc.fi/OPUS-OpenSubtitles/v2016/mono/es.txt.gz' -O dataset.txt.gz")
#   os.system("gzip -d dataset.txt.gz")
#   os.system("mkdir spanberta/data")
#   os.system("mv dataset.txt spanberta/data")
#
# # Total number of lines and some random lines
# os.system("wc -l spanberta/data/dataset.txt")
# os.system("shuf -n 5 spanberta/data/dataset.txt")
#
# # Get a subset of first 10,000,000 lines for training
# TRAIN_SIZE = 10000000 #@param {type:"integer"}
# os.system("(head -n $TRAIN_SIZE spanberta/data/dataset.txt) > spanberta/data/train.txt")
#
# # Get a subset of next 10,000 lines for validation
# VAL_SIZE = 10000 #@param {type:"integer"}
# os.system("(sed -n {TRAIN_SIZE + 1},{TRAIN_SIZE + VAL_SIZE}p spanberta/data/dataset.txt) > spanberta/data/dev.txt")


# Training the tokenizer

# path = "spanberta/data/train.txt"
#
...
#
# # Save files to disk
# if not os.path.exists('spanberta/models'):
#     os.system("mkdir -p 'spanberta/models'")
# tokenizer.save("spanberta/models/spanberta")
#
#
# # Model architecture
# config = {
...
# }
#
# with open("spanberta/models/config.json", 'w') as fp:
#     json.dump(config, fp)
#
# tokenizer_config = {"max_len": 512}
#
# with open("spanberta/models/tokenizer_config.json", 'w') as fp:
